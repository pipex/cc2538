#[doc = "Reader of register DCGCRFC"]
pub type R = crate::R<u32, super::DCGCRFC>;
#[doc = "Writer for register DCGCRFC"]
pub type W = crate::W<u32, super::DCGCRFC>;
#[doc = "Register DCGCRFC `reset()`'s with value 0"]
impl crate::ResetValue for super::DCGCRFC {
    type Type = u32;
    #[inline(always)]
