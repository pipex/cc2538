#[doc = "Reader of register RCGCRFC"]
pub type R = crate::R<u32, super::RCGCRFC>;
#[doc = "Writer for register RCGCRFC"]
pub type W = crate::W<u32, super::RCGCRFC>;
#[doc = "Register RCGCRFC `reset()`'s with value 0"]
impl crate::ResetValue for super::RCGCRFC {
    type Type = u32;
    #[inline(always)]
