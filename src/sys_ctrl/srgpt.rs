#[doc = "Reader of register SRGPT"]
pub type R = crate::R<u32, super::SRGPT>;
#[doc = "Writer for register SRGPT"]
pub type W = crate::W<u32, super::SRGPT>;
#[doc = "Register SRGPT `reset()`'s with value 0"]
impl crate::ResetValue for super::SRGPT {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 3 - 3:3\\] 0: GPT3 module is not reset 1: GPT3 module is reset"]
    #[inline(always)]
    pub fn gpt3(&self) -> GPT3_R {
        GPT3_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 2 - 2:2\\] 0: GPT2 module is not reset 1: GPT2 module is reset"]
    #[inline(always)]
    pub fn gpt2(&self) -> GPT2_R {
        GPT2_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 1 - 1:1\\] 0: GPT1 module is not reset 1: GPT1 module is reset"]
    #[inline(always)]
    pub fn gpt1(&self) -> GPT1_R {
        GPT1_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 0 - 0:0\\] 0: GPT0 module is not reset 1: GPT0 module is reset"]
    #[inline(always)]
