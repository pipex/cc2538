#[doc = "Reader of register RCGCUART"]
pub type R = crate::R<u32, super::RCGCUART>;
#[doc = "Writer for register RCGCUART"]
pub type W = crate::W<u32, super::RCGCUART>;
#[doc = "Register RCGCUART `reset()`'s with value 0"]
impl crate::ResetValue for super::RCGCUART {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 1 - 1:1\\] 0: Clock for UART1 is gated. 1: Clock for UART1 is enabled."]
    #[inline(always)]
    pub fn uart1(&self) -> UART1_R {
        UART1_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 0 - 0:0\\] 0: Clock for UART0 is gated. 1: Clock for UART0 is enabled."]
    #[inline(always)]
