#[doc = "Reader of register SRSEC"]
pub type R = crate::R<u32, super::SRSEC>;
#[doc = "Writer for register SRSEC"]
pub type W = crate::W<u32, super::SRSEC>;
#[doc = "Register SRSEC `reset()`'s with value 0"]
impl crate::ResetValue for super::SRSEC {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 1 - 1:1\\] 0: AES module is not reset 1: AES module is reset"]
    #[inline(always)]
    pub fn aes(&self) -> AES_R {
        AES_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 0 - 0:0\\] 0: PKA module is not reset 1: PKA module is reset"]
    #[inline(always)]
