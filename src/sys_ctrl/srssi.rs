#[doc = "Reader of register SRSSI"]
pub type R = crate::R<u32, super::SRSSI>;
#[doc = "Writer for register SRSSI"]
pub type W = crate::W<u32, super::SRSSI>;
#[doc = "Register SRSSI `reset()`'s with value 0"]
impl crate::ResetValue for super::SRSSI {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 1 - 1:1\\] 0: SSI1 module is not reset 1: SSI1 module is reset"]
    #[inline(always)]
    pub fn ssi1(&self) -> SSI1_R {
        SSI1_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 0 - 0:0\\] 0: SSI0 module is not reset 1: SSI0 module is reset"]
    #[inline(always)]
