#[doc = "Reader of register ST3"]
pub type R = crate::R<u32, super::ST3>;
#[doc = "Writer for register ST3"]
pub type W = crate::W<u32, super::ST3>;
#[doc = "Register ST3 `reset()`'s with value 0"]
impl crate::ResetValue for super::ST3 {
    type Type = u32;
    #[inline(always)]
