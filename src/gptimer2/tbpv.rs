...
#[doc = "Writer for register TBPV"]
pub type W = crate::W<u32, super::TBPV>;
#[doc = "Register TBPV `reset()`'s with value 0"]
impl crate::ResetValue for super::TBPV {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 0:15 - 15:0\\] GPTM Timer B prescaler value"]
    #[inline(always)]
