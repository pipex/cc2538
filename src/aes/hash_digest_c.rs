#[doc = "Reader of register HASH_DIGEST_C"]
pub type R = crate::R<u32, super::HASH_DIGEST_C>;
#[doc = "Writer for register HASH_DIGEST_C"]
pub type W = crate::W<u32, super::HASH_DIGEST_C>;
#[doc = "Register HASH_DIGEST_C `reset()`'s with value 0"]
impl crate::ResetValue for super::HASH_DIGEST_C {
    type Type = u32;
    #[inline(always)]
