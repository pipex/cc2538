#[doc = "Reader of register HASH_DATA_IN_3"]
pub type R = crate::R<u32, super::HASH_DATA_IN_3>;
#[doc = "Writer for register HASH_DATA_IN_3"]
pub type W = crate::W<u32, super::HASH_DATA_IN_3>;
#[doc = "Register HASH_DATA_IN_3 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASH_DATA_IN_3 {
    type Type = u32;
    #[inline(always)]
