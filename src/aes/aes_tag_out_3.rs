#[doc = "Reader of register AES_TAG_OUT_3"]
pub type R = crate::R<u32, super::AES_TAG_OUT_3>;
#[doc = "Writer for register AES_TAG_OUT_3"]
pub type W = crate::W<u32, super::AES_TAG_OUT_3>;
#[doc = "Register AES_TAG_OUT_3 `reset()`'s with value 0"]
impl crate::ResetValue for super::AES_TAG_OUT_3 {
    type Type = u32;
    #[inline(always)]
