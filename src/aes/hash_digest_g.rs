#[doc = "Reader of register HASH_DIGEST_G"]
pub type R = crate::R<u32, super::HASH_DIGEST_G>;
#[doc = "Writer for register HASH_DIGEST_G"]
pub type W = crate::W<u32, super::HASH_DIGEST_G>;
#[doc = "Register HASH_DIGEST_G `reset()`'s with value 0"]
impl crate::ResetValue for super::HASH_DIGEST_G {
    type Type = u32;
    #[inline(always)]
