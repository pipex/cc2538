#[doc = "Reader of register HASH_DIGEST_E"]
pub type R = crate::R<u32, super::HASH_DIGEST_E>;
#[doc = "Writer for register HASH_DIGEST_E"]
pub type W = crate::W<u32, super::HASH_DIGEST_E>;
#[doc = "Register HASH_DIGEST_E `reset()`'s with value 0"]
impl crate::ResetValue for super::HASH_DIGEST_E {
    type Type = u32;
    #[inline(always)]
