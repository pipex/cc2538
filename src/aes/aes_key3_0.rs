#[doc = "Reader of register AES_KEY3_0"]
pub type R = crate::R<u32, super::AES_KEY3_0>;
#[doc = "Writer for register AES_KEY3_0"]
pub type W = crate::W<u32, super::AES_KEY3_0>;
#[doc = "Register AES_KEY3_0 `reset()`'s with value 0"]
impl crate::ResetValue for super::AES_KEY3_0 {
    type Type = u32;
    #[inline(always)]
