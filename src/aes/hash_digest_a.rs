#[doc = "Reader of register HASH_DIGEST_A"]
pub type R = crate::R<u32, super::HASH_DIGEST_A>;
#[doc = "Writer for register HASH_DIGEST_A"]
pub type W = crate::W<u32, super::HASH_DIGEST_A>;
#[doc = "Register HASH_DIGEST_A `reset()`'s with value 0"]
impl crate::ResetValue for super::HASH_DIGEST_A {
    type Type = u32;
    #[inline(always)]
