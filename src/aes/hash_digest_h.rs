#[doc = "Reader of register HASH_DIGEST_H"]
pub type R = crate::R<u32, super::HASH_DIGEST_H>;
#[doc = "Writer for register HASH_DIGEST_H"]
pub type W = crate::W<u32, super::HASH_DIGEST_H>;
#[doc = "Register HASH_DIGEST_H `reset()`'s with value 0"]
impl crate::ResetValue for super::HASH_DIGEST_H {
    type Type = u32;
    #[inline(always)]
