#[doc = "Reader of register HASH_DIGEST_D"]
pub type R = crate::R<u32, super::HASH_DIGEST_D>;
#[doc = "Writer for register HASH_DIGEST_D"]
pub type W = crate::W<u32, super::HASH_DIGEST_D>;
#[doc = "Register HASH_DIGEST_D `reset()`'s with value 0"]
impl crate::ResetValue for super::HASH_DIGEST_D {
    type Type = u32;
    #[inline(always)]
