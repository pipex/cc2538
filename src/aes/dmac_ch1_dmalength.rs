#[doc = "Reader of register DMAC_CH1_DMALENGTH"]
pub type R = crate::R<u32, super::DMAC_CH1_DMALENGTH>;
#[doc = "Writer for register DMAC_CH1_DMALENGTH"]
pub type W = crate::W<u32, super::DMAC_CH1_DMALENGTH>;
#[doc = "Register DMAC_CH1_DMALENGTH `reset()`'s with value 0"]
impl crate::ResetValue for super::DMAC_CH1_DMALENGTH {
    type Type = u32;
    #[inline(always)]
