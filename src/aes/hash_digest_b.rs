#[doc = "Reader of register HASH_DIGEST_B"]
pub type R = crate::R<u32, super::HASH_DIGEST_B>;
#[doc = "Writer for register HASH_DIGEST_B"]
pub type W = crate::W<u32, super::HASH_DIGEST_B>;
#[doc = "Register HASH_DIGEST_B `reset()`'s with value 0"]
impl crate::ResetValue for super::HASH_DIGEST_B {
    type Type = u32;
    #[inline(always)]
