#[doc = "Reader of register HASH_DATA_IN_5"]
pub type R = crate::R<u32, super::HASH_DATA_IN_5>;
#[doc = "Writer for register HASH_DATA_IN_5"]
pub type W = crate::W<u32, super::HASH_DATA_IN_5>;
#[doc = "Register HASH_DATA_IN_5 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASH_DATA_IN_5 {
    type Type = u32;
    #[inline(always)]
