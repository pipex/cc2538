#[doc = "Reader of register HASH_DATA_IN_13"]
pub type R = crate::R<u32, super::HASH_DATA_IN_13>;
#[doc = "Writer for register HASH_DATA_IN_13"]
pub type W = crate::W<u32, super::HASH_DATA_IN_13>;
#[doc = "Register HASH_DATA_IN_13 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASH_DATA_IN_13 {
    type Type = u32;
    #[inline(always)]
