#[doc = "Reader of register AES_KEY2_1"]
pub type R = crate::R<u32, super::AES_KEY2_1>;
#[doc = "Writer for register AES_KEY2_1"]
pub type W = crate::W<u32, super::AES_KEY2_1>;
#[doc = "Register AES_KEY2_1 `reset()`'s with value 0"]
impl crate::ResetValue for super::AES_KEY2_1 {
    type Type = u32;
    #[inline(always)]
