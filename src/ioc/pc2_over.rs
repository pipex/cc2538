#[doc = "Reader of register PC2_OVER"]
pub type R = crate::R<u32, super::PC2_OVER>;
#[doc = "Writer for register PC2_OVER"]
pub type W = crate::W<u32, super::PC2_OVER>;
#[doc = "Register PC2_OVER `reset()`'s with value 0"]
impl crate::ResetValue for super::PC2_OVER {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `PC2_over`"]
pub type PC2_OVER_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `PC2_over`"]
