#[doc = "Reader of register GPT3OCP1"]
pub type R = crate::R<u32, super::GPT3OCP1>;
#[doc = "Writer for register GPT3OCP1"]
pub type W = crate::W<u32, super::GPT3OCP1>;
#[doc = "Register GPT3OCP1 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPT3OCP1 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 0:4 - 4:0\\] 0: PA0 selected as GPT3OCP1 1: PA1 selected as GPT3OCP1 ... 31: PD7 selected as GPT3OCP1"]
    #[inline(always)]
