#[doc = "Reader of register GPT0OCP1"]
pub type R = crate::R<u32, super::GPT0OCP1>;
#[doc = "Writer for register GPT0OCP1"]
pub type W = crate::W<u32, super::GPT0OCP1>;
#[doc = "Register GPT0OCP1 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPT0OCP1 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 0:4 - 4:0\\] 0: PA0 selected as GPT0OCP1 1: PA1 selected as GPT0OCP1 ... 31: PD7 selected as GPT0OCP1"]
    #[inline(always)]
