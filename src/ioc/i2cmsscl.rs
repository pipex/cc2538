#[doc = "Reader of register I2CMSSCL"]
pub type R = crate::R<u32, super::I2CMSSCL>;
#[doc = "Writer for register I2CMSSCL"]
pub type W = crate::W<u32, super::I2CMSSCL>;
#[doc = "Register I2CMSSCL `reset()`'s with value 0"]
impl crate::ResetValue for super::I2CMSSCL {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 0:4 - 4:0\\] 0: PA0 selected as I2C SCL 1: PA1 selected as I2C SCL ... 31: PD7 selected as I2C SCL"]
    #[inline(always)]
