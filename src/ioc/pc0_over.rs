#[doc = "Reader of register PC0_OVER"]
pub type R = crate::R<u32, super::PC0_OVER>;
#[doc = "Writer for register PC0_OVER"]
pub type W = crate::W<u32, super::PC0_OVER>;
#[doc = "Register PC0_OVER `reset()`'s with value 0"]
impl crate::ResetValue for super::PC0_OVER {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `PC0_over`"]
pub type PC0_OVER_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `PC0_over`"]
