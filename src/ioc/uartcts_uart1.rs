#[doc = "Reader of register UARTCTS_UART1"]
pub type R = crate::R<u32, super::UARTCTS_UART1>;
#[doc = "Writer for register UARTCTS_UART1"]
pub type W = crate::W<u32, super::UARTCTS_UART1>;
#[doc = "Register UARTCTS_UART1 `reset()`'s with value 0"]
impl crate::ResetValue for super::UARTCTS_UART1 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 0:4 - 4:0\\] 0: PA0 selected as UART1 CTS 1: PA1 selected as UART1 CTS ... 31: PD7 selected as UART1 CTS"]
    #[inline(always)]
