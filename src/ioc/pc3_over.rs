#[doc = "Reader of register PC3_OVER"]
pub type R = crate::R<u32, super::PC3_OVER>;
#[doc = "Writer for register PC3_OVER"]
pub type W = crate::W<u32, super::PC3_OVER>;
#[doc = "Register PC3_OVER `reset()`'s with value 0"]
impl crate::ResetValue for super::PC3_OVER {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `PC3_over`"]
pub type PC3_OVER_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `PC3_over`"]
