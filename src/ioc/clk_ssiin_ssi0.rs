#[doc = "Reader of register CLK_SSIIN_SSI0"]
pub type R = crate::R<u32, super::CLK_SSIIN_SSI0>;
#[doc = "Writer for register CLK_SSIIN_SSI0"]
pub type W = crate::W<u32, super::CLK_SSIIN_SSI0>;
#[doc = "Register CLK_SSIIN_SSI0 `reset()`'s with value 0"]
impl crate::ResetValue for super::CLK_SSIIN_SSI0 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 0:4 - 4:0\\] 0: PA0 selected as SSI0 CLK_SSIN 1: PA1 selected as SSI0 CLK_SSIN ... 31: PD7 selected as SSI0 CLK_SSIN"]
    #[inline(always)]
