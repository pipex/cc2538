#[doc = "Reader of register I2CMSSDA"]
pub type R = crate::R<u32, super::I2CMSSDA>;
#[doc = "Writer for register I2CMSSDA"]
pub type W = crate::W<u32, super::I2CMSSDA>;
#[doc = "Register I2CMSSDA `reset()`'s with value 0"]
impl crate::ResetValue for super::I2CMSSDA {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 0:4 - 4:0\\] 0: PA0 selected as I2C SDA 1: PA1 selected as I2C SDA ... 31: PD7 selected as I2C SDA"]
    #[inline(always)]
