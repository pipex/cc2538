#[doc = "Reader of register CLK_SSI_SSI1"]
pub type R = crate::R<u32, super::CLK_SSI_SSI1>;
#[doc = "Writer for register CLK_SSI_SSI1"]
pub type W = crate::W<u32, super::CLK_SSI_SSI1>;
#[doc = "Register CLK_SSI_SSI1 `reset()`'s with value 0"]
impl crate::ResetValue for super::CLK_SSI_SSI1 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 0:4 - 4:0\\] 0: PA0 selected as SSI1 CLK 1: PA1 selected as SSI1 CLK ... 31: PD7 selected as SSI1 CLK"]
    #[inline(always)]
