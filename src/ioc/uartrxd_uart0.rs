#[doc = "Reader of register UARTRXD_UART0"]
pub type R = crate::R<u32, super::UARTRXD_UART0>;
#[doc = "Writer for register UARTRXD_UART0"]
pub type W = crate::W<u32, super::UARTRXD_UART0>;
#[doc = "Register UARTRXD_UART0 `reset()`'s with value 0"]
impl crate::ResetValue for super::UARTRXD_UART0 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 0:4 - 4:0\\] 0: PA0 selected as UART0 RX 1: PA1 selected as UART0 RX ... 31: PD7 selected as UART0 RX"]
    #[inline(always)]
