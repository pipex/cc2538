#[doc = "Reader of register GPT0OCP2"]
pub type R = crate::R<u32, super::GPT0OCP2>;
#[doc = "Writer for register GPT0OCP2"]
pub type W = crate::W<u32, super::GPT0OCP2>;
#[doc = "Register GPT0OCP2 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPT0OCP2 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 0:4 - 4:0\\] 0: PA0 selected as GPT0OCP2 1: PA1 selected as GPT0OCP2 ... 31: PD7 selected as GPT0OCP2"]
    #[inline(always)]
