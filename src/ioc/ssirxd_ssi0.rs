#[doc = "Reader of register SSIRXD_SSI0"]
pub type R = crate::R<u32, super::SSIRXD_SSI0>;
#[doc = "Writer for register SSIRXD_SSI0"]
pub type W = crate::W<u32, super::SSIRXD_SSI0>;
#[doc = "Register SSIRXD_SSI0 `reset()`'s with value 0"]
impl crate::ResetValue for super::SSIRXD_SSI0 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 0:4 - 4:0\\] 0: PA0 selected as SSI0 RX 1: PA1 selected as SSI0 RX ... 31: PD7 selected as SSI0 RX"]
    #[inline(always)]
