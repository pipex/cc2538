#[doc = "Reader of register DACTEST0"]
pub type R = crate::R<u32, super::DACTEST0>;
#[doc = "Writer for register DACTEST0"]
pub type W = crate::W<u32, super::DACTEST0>;
#[doc = "Register DACTEST0 `reset()`'s with value 0"]
impl crate::ResetValue for super::DACTEST0 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `DAC_Q_O`"]
pub type DAC_Q_O_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `DAC_Q_O`"]
pub struct DAC_Q_O_W<'a> {
    w: &'a mut W,
}
impl<'a> DAC_Q_O_W<'a> {
    #[doc = r"Writes raw bits to the field"]
...
impl W {
    ...
    #[doc = "Bits 0:7 - 7:0\\] Q-branch DAC override value when DAC_SRC = 001 If DAC_SRC is set to be ADC data, CORDIC magnitude, or channel filtered data, then DAC_Q_O controls the part of the word in question that is actually multiplexed to the DAC, as described below. 000111: Bits 7:0 001000: Bits 8:1 001001: Bits 9:2 ... If an invalid setting is chosen, the DAC outputs only zeros (minimum value)."]
    #[inline(always)]
    pub fn dac_q_o(&mut self) -> DAC_Q_O_W {
        DAC_Q_O_W { w: self }
    }
}
