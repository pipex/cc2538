...
impl R {
    ...
    #[doc = "Bits 0:7 - 7:0\\] Masked value of interrupt due to corresponding pin Bits clear: GPIO line interrupt not active Bits set: GPIO line asserting interrupt"]
    #[inline(always)]
