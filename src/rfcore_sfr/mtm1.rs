#[doc = "Reader of register MTM1"]
pub type R = crate::R<u32, super::MTM1>;
#[doc = "Writer for register MTM1"]
pub type W = crate::W<u32, super::MTM1>;
#[doc = "Register MTM1 `reset()`'s with value 0"]
impl crate::ResetValue for super::MTM1 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `MTM1`"]
pub type MTM1_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `MTM1`"]
pub struct MTM1_W<'a> {
    w: &'a mut W,
}
impl<'a> MTM1_W<'a> {
